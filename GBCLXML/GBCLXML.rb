  ...
  class Tokens    
    def self.representation(a)      
      if    a.is_a?(String)
        ...
        elsif a ==      "cettef"; puts "</#{a.chop}>"
        elsif a ==   "maisettef"; puts "</#{a.chop}>"
        elsif a ==      "sinonf"; puts "</#{a.chop}>"
        elsif a ==       "soref"; puts "</#{a.chop}>"
        elsif a ==   "shikashif"; puts "</#{a.chop}>"
        elsif a ==     "matawaf"; puts "</#{a.chop}>"
        ...
        elsif a ==    "necettef"; puts "</#{a.chop}>"
        elsif a == "nemaisettef"; puts "</#{a.chop}>"
        elsif a ==    "nesinonf"; puts "</#{a.chop}>"
        elsif a ==     "nesoref"; puts "</#{a.chop}>"
        elsif a == "neshikashif"; puts "</#{a.chop}>"
        elsif a ==   "nematawaf"; puts "</#{a.chop}>"
        else
          print "#{a} "
        end
      else
    ...
    #    elsif b ==    "cettef"; puts "</#{a.chop}>"
    #    elsif b == "maisettef"; puts "</#{a.chop}>"
    #    elsif b ==    "sinonf"; puts "</#{a.chop}>"
    #    elsif b ==     "soref"; puts "</#{a.chop}>"
    #    elsif b == "shikashif"; puts "</#{a.chop}>"
    #    elsif b ==   "matawaf"; puts "</#{a.chop}>"
    #    else
    #      print "#{b} "
    #    end
    #  else
